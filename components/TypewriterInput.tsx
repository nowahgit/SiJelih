...
export default function TypewriterInput() {
  ...
  return (
    <div className="w-full max-w-[540px] mx-auto lg:mx-0 bg-white border border-[#e5e7eb] rounded-[8px] px-[18px] h-[52px] min-h-[52px] max-h-[52px] flex flex-row flex-nowrap items-center gap-[10px] shadow-[0_1px_2px_rgba(0,0,0,0.04)] overflow-hidden box-border">
      ...
      <div className="font-mono text-[14px] leading-none text-[#374151] flex-1 text-left flex items-center overflow-hidden min-w-0 h-full">
        <span className="truncate whitespace-nowrap overflow-hidden text-ellipsis flex-1 block">{text}</span>
        <span className={`text-[#2563eb] transition-opacity duration-100 flex-shrink-0 ml-0.5 ${cursorVisible ? "opacity-100" : "opacity-0"}`}>|</span>
      </div>
